...
function showPage(page){
    ...
    switch(page){
        ...
        case "deposits":
            section = document.getElementById("depositSection");
            break;

        case "withdraws":
            section = document.getElementById("withdrawSection");
            break;

        case "users":
            section = document.getElementById("usersSection");
            break;

        case "transactions":
            section = document.getElementById("transactionsSection");
            break;

        case "settings":
            section = document.getElementById("settingsSection");
            break;
