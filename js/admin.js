        ...
        if (notificationKey) {
            ...
            await set(
                ...
                ),
                {
                    ...
                    message:
                        `Your ${vipData.vipPlan} VIP has been approved.`,
...
async function processReferralBonus(
    ...
    try {
        ...
        /* -----------------------------------------
           IF referredBy is already UID
        ----------------------------------------- */

        const possibleUserRef =
            ref(
                db,
                `users/${referredBy}`
            );

        const possibleUserSnapshot =
            await get(
                possibleUserRef
            );


        if (possibleUserSnapshot.exists()) {
        ...
        /* -----------------------------------------
           OTHERWISE SEARCH referralCodes
        ----------------------------------------- */
        ...
        const result =
            await runTransaction(
                ...
                (currentData) => {
                    ...
                    if (
                        currentData.lastReferralBonusRequestId ===
                        requestId
                    ) {
                        return;
                    }
                    ...
                    return {
                        ...
                        referralBonus:
                            Number(
                                currentData.referralBonus || 0
                            ) +
                            bonus,

                        referralEarnings:
                            Number(
                                currentData.referralEarnings || 0
                            ) +
                            bonus,

                        referralCount:
                            Number(
                                currentData.referralCount || 0
                            ) +
                            1,
        ...
        await update(
            userRef,
            {
                ...
                referralBonusApprovedAt:
                    Date.now(),

                referralBonusRequestId:
                    requestId
        ...
        if (transactionKey) {
            ...
            await set(
                ...
                ),
                {
                    ...
                    description:
                        "Referral bonus from approved VIP",
